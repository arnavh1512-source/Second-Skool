...
Vendored from https://github.com/JuliusBrussee/caveman (`skills/` is MIT).
Everything above this rule is upstream verbatim — re-sync by overwriting it
with the upstream `plugins/caveman/skills/caveman/SKILL.md`.
