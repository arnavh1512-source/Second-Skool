      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-td-soft p-6">
          <div className="text-center max-w-xs">
            <div className="w-16 h-16 rounded-td bg-td-tint-red flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-td-title td-strong mb-2">Something went wrong</div>
            ...
            <div className="text-td-small text-td-muted mb-5 leading-relaxed">This screen failed to load. Your data is safe — try again, and if it keeps happening, close and reopen the app.</div>
            <button
              onClick={() => this.setState({ hasError: false, error: null })}
              className="td-pill text-td-small font-semibold py-3 px-8 rounded-td cursor-pointer"
            >
              Try again
            </button>
          </div>
