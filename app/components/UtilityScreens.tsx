    ...
    <div className="td-screen">
      ...
      <div className="td-form-card mb-[22px]">
        ...
        <div className="grid grid-cols-2 gap-[11px]">
          <label className="block"><span className="td-label">Date</span><input type="date" value={date} onChange={e => setDate(e.target.value)} className="td-field" /></label>
          <label className="block"><span className="td-label">Time</span><input value={time} onChange={e => setTime(e.target.value)} className="td-field" /></label>
        </div>
...
export function MoreScreen() {
  ...
  return (
    <div className="td-screen">
      ...
      {isAdmin && (
        <>
          <div className="text-td-small font-semibold text-td-muted mt-5 mb-[11px] px-1">Management</div>
          {card(management)}
        </>
      )}
  ...
  return (
    <div className="td-screen">
      ...
      <div className="flex flex-col gap-3.5 mb-[18px]">
        <label className="block"><span className="td-label">Full name</span><input value={name} onChange={e => setName(e.target.value)} placeholder="Your name" className="td-field" /></label>
        <label className="block"><span className="td-label">Phone</span><input value={phone} onChange={e => setPhone(e.target.value)} placeholder="+91" className="td-field" /></label>
        <label className="block"><span className="td-label">Subject you teach</span><input value={subject} onChange={e => setSubject(e.target.value)} placeholder="e.g. Mathematics, Physics" className="td-field" /></label>
        <label className="block"><span className="td-label">Qualification</span><input value={qualification} onChange={e => setQualification(e.target.value)} placeholder="e.g. M.Sc. Mathematics" className="td-field" /></label>
        {isAdmin && (
          <label className="block"><span className="td-label">Centre name</span><input value={centre} onChange={e => setCentre(e.target.value)} placeholder="e.g. Bright Future Tuition" className="td-field" /></label>
        )}
        {isAdmin && (
