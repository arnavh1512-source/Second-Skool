...
export default function NotFound() {
  return (
    <main className="min-h-[100dvh] flex flex-col items-center justify-center text-center px-6 bg-td-soft">
      ...
      <h1 className="text-xl font-extrabold text-td-dark mt-3">Page not found</h1>
      <p className="text-[15px] text-td-muted mt-2 max-w-[320px]">
        The page you&apos;re looking for doesn&apos;t exist or may have moved.
      </p>
      <Link
        href="/"
        className="mt-7 inline-flex items-center justify-center bg-td-primary text-white text-[15px] font-extrabold py-3.5 px-7 rounded-2xl no-underline"
      >
