...
export default function NotFound() {
  return (
    <main className="min-h-[100dvh] flex flex-col items-center justify-center text-center px-6 bg-td-soft">
      <div
        className="w-[72px] h-[72px] rounded-td-lg flex items-center justify-center text-white font-semibold text-3xl mb-6 shadow-td-raised"
      ...
      <Link
        href="/"
        className="mt-7 inline-flex items-center justify-center bg-td-primary text-td-on-solid text-td-body font-semibold py-3.5 px-7 rounded-td-md no-underline"
      >
